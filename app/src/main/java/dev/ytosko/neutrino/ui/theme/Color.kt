...
/*
 * Neutrino's palette: a clean, cool-neutral base (white cards on a soft grey page) so food photos
 * and data colours stand out, coral (the logo) for the brand and main actions only, and a family
...
internal val LightColors = lightColorScheme(
    ...
    secondary = Color(0xFF475467),            // slate: calm secondary actions
    ...
    onBackground = Color(0xFF1A1D23),         // 15.8:1
    surface = Color(0xFFF5F6F8),
    onSurface = Color(0xFF1A1D23),
    surfaceVariant = Color(0xFFE4E7EC),
    onSurfaceVariant = Color(0xFF555C68),     // 6.6:1 on the page, 7.1:1 on cards
